...
//********************
inline void eDictionary::SetFloat( const char * key, float value ) {
	snprintf(setBuffer.data(), setBuffer.size(), "%f", value);
...
// eDictionary::SetInt
//********************
inline void eDictionary::SetInt( const char * key, int value ) {
	snprintf(setBuffer.data(), setBuffer.size(), "%i", value);
	Set( key, setBuffer.data() );
}
...
// eDictionary::SetBool
//********************
inline void eDictionary::SetBool( const char * key, bool value ) {
	snprintf(setBuffer.data(), setBuffer.size(), "%i", value);
	Set( key, setBuffer.data() );
}
